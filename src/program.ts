...
export function createProgram(): Command {
  ...
  program.command("publish").description("publish new usage to your public profile; sign in if needed").option("--full", "check all local history for usage missing from your profile").action(publish);
